			...
			<table class="table table-bordered">
				<tbody>		            
		            <tr>	            
		                ...
		                <td><input type="text" placeholder="제목을 입력하세요. " name="donationPlanTitle" class="form-control"/></td>	                
		            </tr>
		            <tr>	            
		                <th class="active">내용 </th>
		                <td><textarea cols="10" placeholder="500자 이내에 입력하세요 " rows="30" name="donationPlanContent" id="donationPalnContent" class="form-control" maxlength="500"></textarea></td>	            
		            </tr>
		            <tr>	            
		                <th class="active">목적 </th>
		                <td><textarea cols="10" placeholder="100자 이내에 입력하세요" rows="10" name="donationPlanPurpose" class="form-control" maxlength="30"></textarea></td>	            
		            </tr>
		            <tr>	            
		            ...
		            <tr>	            
		                ...
		                <td><input name="donationPlanUseTerm" id="date" type="date">이내</td>	            
		            </tr>
		            <tr>	           
