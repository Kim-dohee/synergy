...
<div style="font-size:16px">
	...
	<form class="form-horizontal" role="form" method="post"
		...
		<div class="form-group" id="divId">
			...
			<div class="col-lg-4">
				<input type="text" class="form-control onlyAlphabetAndNumber"
					value="${donator.donatorId}" readonly name="donatorId" id="id"
		...
		<div class="form-group" id="divPassword">
			...
			<div class="col-lg-4">
				<input type="password" class="form-control"
					value="${donator.donatorPw}" name="donatorPw" id="password"
		...
		<div class="form-group" id="divName">
			...
			<div class="col-lg-4">
				<input type="text" class="form-control onlyHangul"
					value="${donator.donatorName}" readonly name="donatorName"
		...
		<div class="form-group" id="divBusinessNo">
			...
			<div class="col-lg-4">
				<input type="text" class="form-control"
					value="${donator.donatorBusinessNo}" name="donatorBusinessNo"
					id=BusinessNo data-rule-required="true" placeholder="사업자번호"
					maxlength="15">
			</div>
			<div class="col-lg-4"></div>
		</div>
		<div class="form-group" id="divHomepage">
			...
			<div class="col-lg-4">
				<input type="text" class="form-control"
					value="${donator.donatorHomepage}" name="donatorHomepage"
		...
		<div class="form-group" id="divPhoneNumber">
			<label for="inputPhoneNumber" class="col-lg-2 control-label">기부단체
				전화번호</label>
			<div class="col-lg-4">
				<input type="tel" class="form-control onlyNumber"
					value="${donator.donatorTelephone}" name="donatorTelephone"
